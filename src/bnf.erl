...
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 45 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 47, C =< 91 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
...
-file("include/bnf.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { nonterminal, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("include/bnf.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { terminal, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("include/bnf.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { pipe, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("include/bnf.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { equals, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/0}).
-file("include/bnf.xrl", 13).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/0}).
-file("include/bnf.xrl", 14).
yyaction_5() ->
     skip_token .

-compile({inline,yyaction_6/2}).
-file("include/bnf.xrl", 15).
yyaction_6(TokenChars, TokenLine) ->
     { token, { end_of_rule, TokenLine, TokenChars } } .
